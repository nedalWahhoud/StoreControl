...
namespace StoreControl
{
    internal class staticVariable
    {
        ...
        public static List<string> columnOrderC = new List<string>  { "rowIndex", "customerId",  "firstName", "lastName", "phone", "email" , "street",
        ...
        public static List<string> keywordC = new List<string> { "customerId", "firstName", "lastName", "phone", "email", "street", "city","country", "postalCode", "latitude", "longitude", "noData" };
